...
public class SubComp {
    ...
    protected int nbEmployee, rebuyDate;
    protected double revenue2015;
    ...
    public SubComp(String name, String origin, double revenue2015, int nbEmployee, int rebuyDate){
        this.name = name;
        this.origin = origin;
